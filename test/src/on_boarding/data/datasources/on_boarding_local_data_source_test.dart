...
void main() {
  ...
  setUp(() {
    ...
    localDataSource = OnBaordingLocalDataSourceImpl(prefs);
  });
  ...
  group('checkIfUserIsFirstTimer', () {
    test(
        'should call [SharedPreferences] to check if user is first timer adn '
    ...
    test('should return if there is no data in storage', () async {
      when(
        () => prefs.getBool(any()),
      ).thenReturn(null);
